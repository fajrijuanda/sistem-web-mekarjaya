{{--
    Formulir ini dirancang berdasarkan SURAT PENGANTAR SKCK.
...
<div class="row g-3">
    <div class="col-md-12">
        <label class="form-label" for="form_data[no_kk]">Nomor Kartu Keluarga (No. KK)</label>
        <input type="text" id="form_data[no_kk]" name="form_data[no_kk]" class="form-control"
            placeholder="16 Digit Nomor Kartu Keluarga" value="{{ old('form_data.no_kk') }}" required />
    </div>
    <div class="col-md-6">
        ...
        <input type="text" id="form_data[tempat_lahir]" name="form_data[tempat_lahir]" class="form-control"
            placeholder="Contoh: Bekasi" value="{{ old('form_data.tempat_lahir') }}" required />
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <input type="text" id="form_data[pekerjaan]" name="form_data[pekerjaan]" class="form-control"
            placeholder="Contoh: Mengurus Rumah Tangga" value="{{ old('form_data.pekerjaan') }}" required />
    </div>
    <div class="col-12">
        ...
        <textarea name="form_data[alamat]" id="form_data[alamat]" class="form-control" rows="2"
            placeholder="Alamat lengkap sesuai KTP" required>{{ old('form_data.alamat') }}</textarea>
    </div>
</div>

<hr class="my-4" />

<h5 class="mt-4">3. Keperluan</h5>
<div class="row g-3">
    <div class="col-12">
        <label class="form-label" for="form_data[keperluan]">Keperluan Pembuatan Surat</label>
        <textarea name="form_data[keperluan]" id="form_data[keperluan]" class="form-control" rows="2"
            placeholder="Tuliskan tujuan pembuatan surat ini" required>{{ old('form_data.keperluan', 'Sebagai kelengkapan pengurusan SKCK (Surat Keterangan Catatan Kepolisian).') }}</textarea>
    </div>
</div>
