{{--
    Formulir ini dirancang untuk SURAT PENGANTAR PEMBUATAN PASPOR.
...
<div class="row g-3">
    <div class="col-12">
        ...
        <textarea name="form_data[keperluan]" id="keperluan" class="form-control" rows="2"
            placeholder="Tuliskan tujuan pembuatan surat ini" required>{{ old('form_data.keperluan', 'Sebagai kelengkapan Administrasi dalam Pembuatan PASPOR.') }}</textarea>
    </div>
</div>
